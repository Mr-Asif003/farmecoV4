  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity onPress={()=>{router.replace("./AcceptedPreorder") }} style={styles.Accept}><Text style={{fontSize:18,fontWeight:'400',color:'black'}}>Accepted</Text></TouchableOpacity>
      </View>
    </View>
  );
