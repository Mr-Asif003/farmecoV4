...
const AcceptedPreorder = () => {
  ...
  const renderItem= ({ item }) => (
    <View style={{elevation:2,borderRadius:20, backgroundColor:'#f0fff1',marginTop:10,padding:10 }}>
       <View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity onPress={()=>{router.replace("./Preorder") }}   style={styles.PreOrder}><Text  style={{fontSize:18,fontWeight:'400',color:'black'}}      >PreOrders</Text></TouchableOpacity>
        <TouchableOpacity style={styles.Accept}><Text  style={{fontSize:21,fontWeight:'600',color:'green'}} >Accepted</Text></TouchableOpacity>
      </View>
    </View>
  );
...
export default AcceptedPreorder;
