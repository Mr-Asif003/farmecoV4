  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity  onPress={()=>{router.replace("./fruitPreorder") }}  style={styles.PreOrder}><Text style={{fontSize:21,fontWeight:'600',color:'green'}}>PreOrders</Text></TouchableOpacity>
        <TouchableOpacity  style={styles.Accept}><Text style={{fontSize:18,fontWeight:'400',color:'black'}}>Accepted</Text></TouchableOpacity>
      </View>
    </View>
  )
}
...
export default AcceptedFruitPreorder;
