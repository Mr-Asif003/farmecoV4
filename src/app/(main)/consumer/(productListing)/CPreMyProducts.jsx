...
const  CPreMyProducts = () => {
  ...
  useEffect(() => {
    ...
    const userProductsRef = collection(db, "users", user.uid, "PreOrderFruits");
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.tranButton}>
        ...
        <TouchableOpacity style={styles.vegbtn} onPress={()=>router.replace('./CPreMyProductsVeg')}  ><Text style={styles.vegtxt} >Vegetables</Text></TouchableOpacity>
