...
const  passItemData=(itemId,itemRate,itemtitle)=>{
    ...
    router.replace({ pathname:'./CPreListingPage', params: details })
  }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.welcome}>Welcome to the Vegetable PreOrder store</Text>
      ...
      <View style={styles.tranButton}>
        <View style={styles.btnContainer}>
          ...
          <TouchableOpacity style={styles.fruitbtn} onPress={() => router.replace('./CPreSelectFruits')}><Text style={styles.fruittxt} >Fruits</Text></TouchableOpacity>
        </View>
      </View>
      <ScrollView>
