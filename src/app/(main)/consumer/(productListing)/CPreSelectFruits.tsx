...
import FruitListingPage from './CPreFruitListingPage';
...
const SelectFruits = () => {
  ...
  const  passItemData=(itemId,itemRate,itemtitle)=>{
    ...
    router.replace({ pathname:'./CPreFruitListingPage', params: details })
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tranButton}>
        ...
        <TouchableOpacity style={styles.vegbtn} onPress={()=>router.replace('./CPreSelectVeg')}  ><Text style={styles.vegtxt} >Vegetables</Text></TouchableOpacity>
