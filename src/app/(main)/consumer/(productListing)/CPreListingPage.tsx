...
import SelectVeg from './CPreSelectVeg';


const CPreListingPage = ({ }: { title: string, id: 'string' }) => {
    ...
    const addProduct = async () => {
        ...
        try {
            ...
            await addDoc(collection(userRef, 'PreOrder'), cropData);

            //adding to FarmerProducts db;
            await addDoc(collection(db, "ConsumerPreOrder"), cropData);
        ...
        <View style={styles.container}>
            <View style={styles.topContainer}>
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    <Text style={{ fontSize: 27, fontWeight: '700', marginTop: 1,marginLeft:-2 }}>  PreOrder </Text>
...
export default CPreListingPage