    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.card} >
                        <Text style={{fontSize:39,fontWeight:'700'}}>Weekly Plan</Text>
            ...
            <TouchableOpacity style={{marginBottom:20}} onPress={() => router.replace('./Subsplan')}>
...
const styles = StyleSheet.create({
    ...
    card:{
        height:'70%',width:'130%' ,justifyContent:'center',alignItems:'center',
