...
import Subsplan2 from './Subsweekly';
const Subsplandaily = () => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.topcontainer}>
                <View >
                    <TouchableOpacity style={styles.stackIcon} onPress={() => router.replace('./Subsplan')}>
            ...
            <View style={styles.card} >
                        <Text style={{fontSize:39,fontWeight:'700'}}>Daily Plan</Text>
            ...
            <TouchableOpacity style={{marginBottom:20}} onPress={() => router.replace('./Subsweekly')}>
...
const styles = StyleSheet.create({
    ...
    card:{
        height:'70%',width:'160%' ,justifyContent:'center',alignItems:'center',
