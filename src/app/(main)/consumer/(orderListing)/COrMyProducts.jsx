  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.tranButton}>
        ...
        <TouchableOpacity style={styles.vegbtn} onPress={()=>router.replace('./COrMyProductsVeg')}  ><Text style={styles.vegtxt} >Vegetables</Text></TouchableOpacity>
