    ...
    <View style={styles.container}>
      ...
      <View style={styles.tranButton}>
        <View style={styles.btnContainer}>
          ...
          <TouchableOpacity style={styles.fruitbtn} onPress={() => router.replace('./COrMyProducts')}  ><Text style={styles.fruittxt} >Fruits</Text></TouchableOpacity>
        </View>
      </View>
...
export default COrMyProductsVeg;
