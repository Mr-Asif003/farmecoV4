...
const COrFruitListingPage = ({ }: { title: string, id: 'string' }) => {
    ...
    const addProduct = async () => {
        ...
        try {
            ...
            await addDoc(collection(userRef, 'OrderFruits'), cropData);

            //adding to FarmerProducts db;
            await addDoc(collection(db, "ConsumerOrderFruits"), cropData);
...
export default COrFruitListingPage;